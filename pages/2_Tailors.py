...
from UI_components.tailor_detail_view import render_tailor_detail
...
# --- Detail View Logic ---
if "detail_tailor_id" in st.session_state and st.session_state.detail_tailor_id:
    # Find tailor
    tailor_detail = next((t for t in tailors if t.id == st.session_state.detail_tailor_id), None)
    if tailor_detail:
        render_tailor_detail(tailor_detail, orders)
    else:
        st.error("Tailor not found.")
